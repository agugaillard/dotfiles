# Generated by Powerlevel10k configuration wizard on 2024-08-21 at 23:45 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 16269.
# Wizard options: compatible, unicode, lean_8colors, 1 line, compact, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      added='%2F'  # green foreground
      local       gray='%7F'  # gray foreground
    else
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${gray}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
